  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#f5f5f5' }}>
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6">
          <div className="text-center mb-8 sm:mb-12">
            <h1 className="text-xl sm:text-2xl lg:text-4xl font-bold mb-4 sm:mb-6 text-gray-900">
              Quality <span className="text-gray-900">DIY Products</span>
            </h1>
            <p className="text-sm sm:text-base lg:text-lg max-w-3xl mx-auto mb-6 sm:mb-8 text-gray-600">
      ...
      <main className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 py-6 sm:py-8">
        {/* Categories */}
        <div className="mb-8">
          <h3 className="text-xl font-semibold mb-6 text-gray-900">Shop by Category</h3>
