...
import heroImage from "@assets/homebase-hero-desktop_1765255023288.png";
import heroImageMobile from "@assets/homebase-hero-mobile_1765255048764.png";
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6 leading-tight" style={{ color: typedUser?.role === 'homeowner' ? '#2c0f5b' : 'white' }}>
            {typedUser?.role === 'homeowner' ? (
              <>
                ...
                <span className="md:hidden">Welcome to Your Home's Smart<br />Management Hub</span>
              </>
            ) : (
              <>Your Business{" "}
