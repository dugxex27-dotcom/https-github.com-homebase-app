...
export const US_MAINTENANCE_DATA: { [key: string]: LocationMaintenanceData } = {
  'Northeast': {
    ...
    monthlyTasks: {
      1: { // January
        seasonal: [
          { title: 'Check heating system efficiency', description: 'Ensure your heating system is running efficiently during peak winter. Check thermostat settings, listen for unusual noises, and verify all vents are open and unobstructed. Consider scheduling professional maintenance if performance seems reduced.' },
          ...
          { title: 'Check for ice dams on roof', description: 'Look for icicles or ice buildup at roof edges that can cause water damage. Clear snow from gutters and roof edges if safe to do so. Ensure attic insulation and ventilation are adequate to prevent warm air from melting snow unevenly.' },
          ...
          { title: 'Inspect furnace filter and replace if dirty', description: 'Remove furnace filter and hold it up to light - if you cannot see through it clearly, replace it. Dirty filters reduce efficiency and air quality. Most filters should be changed every 1-3 months during heating season.' },
        ...
        weatherSpecific: [
          ...
          { title: 'Check pipes for freezing in unheated areas', description: 'Inspect pipes in basements, crawl spaces, attics, and exterior walls. Feel pipes for cold spots. Let faucets drip slightly during extreme cold. Open cabinet doors under sinks to allow warm air circulation.' },
      ...
      2: { // February
        seasonal: [
          { title: 'Service heating system before peak winter ends', description: 'Schedule a professional HVAC technician to inspect your furnace or boiler for efficiency and safety. They will check burners, heat exchangers, and electrical components. Address any issues now before the system shuts down for spring.' },
          { title: 'Check attic insulation and ventilation', description: 'Inspect attic insulation for proper depth (10-14 inches minimum in cold climates) and look for compressed or missing areas. Ensure soffit vents and ridge vents are clear of snow and debris to prevent moisture buildup and ice dams.' },
          { title: 'Inspect roof for winter damage', description: 'From the ground or with binoculars, look for missing, cracked, or curled shingles caused by ice and snow. Check flashing around chimneys and vents. Call a professional roofer for any visible damage to prevent leaks.' },
          { title: 'Test sump pump if applicable', description: 'Pour a bucket of water into the sump pit to ensure the pump activates and drains properly. Check that the discharge pipe is clear and draining away from your foundation. Clean the inlet screen if present.' },
          { title: 'Check storm doors and windows', description: 'Inspect weatherstripping and seals on storm doors and windows for gaps or damage. Tighten loose hinges and closers. Clean tracks and ensure proper operation. Replace damaged weatherstripping before spring.' },
          { title: 'Test GFCI/AFCI circuit breakers in electrical panel', description: 'Open your electrical panel and press the "test" button on each GFCI and AFCI breaker - it should trip. Then flip it back to "on." If any breaker fails to trip or won\'t reset, call an electrician immediately.' },
          { title: 'Inspect water heater for leaks and check temperature (~120°F)', description: 'Look around the base of your water heater for puddles or rust. Use a thermometer on hot tap water or check the thermostat setting - it should be around 120°F to prevent scalding and save energy. Wipe away any moisture and monitor.' },
          { title: 'Flush toilets and sinks that aren\'t used often to prevent dry traps', description: 'Run water in guest bathrooms, basement sinks, and other rarely used fixtures for 30 seconds. This refills the drain trap and prevents sewer gases from entering your home. Do this monthly for unused fixtures.' },
          { title: 'Check bathroom exhaust fans for proper airflow', description: 'Turn on each bathroom fan and hold a tissue near the grille - it should be pulled against the vent. Clean the grille with a vacuum attachment. Proper ventilation prevents moisture damage and mold growth.' },
          { title: 'Inspect fire extinguishers for charge and expiration date', description: 'Check the pressure gauge on each fire extinguisher - the needle should be in the green zone. Look for the expiration date or inspection tag. If expired or pressure is low, replace or have it professionally recharged.' }
        ],
        weatherSpecific: [
          { title: 'Monitor for ice damage on gutters', description: 'Look for bent, sagging, or detached gutters caused by ice weight. Check for ice dams forming at roof edges. Safely remove accessible ice with warm (not hot) water. Heavy ice may require professional removal to avoid injury.' },
          { title: 'Check basement for moisture issues', description: 'Look for water stains on walls, floors, and around windows. Feel walls for dampness and check for musty odors indicating mold. Use a dehumidifier if humidity exceeds 50%. Address leaks immediately to prevent structural damage.' },
          { title: 'Ensure proper ventilation to prevent condensation', description: 'Run bathroom and kitchen exhaust fans during and after showers and cooking. Open windows briefly on mild days to exchange air. Check that attic and crawl space vents are clear to prevent moisture buildup and mold.' },
          { title: 'Inspect exterior caulking', description: 'Check caulk around windows, doors, and where siding meets trim for cracks or gaps. Scrape out old, damaged caulk and reapply with exterior-grade caulk on days above 40°F. Proper sealing prevents water intrusion and heat loss.' },
          { title: 'Check for frozen pipe prevention measures', description: 'Feel pipes in unheated areas (basement, crawl space, attic) for cold spots. Open cabinet doors under sinks to allow warm air circulation. Let faucets drip during extreme cold. Add pipe insulation where needed to prevent freezing and bursting.' }
        ],
        priority: 'high'
      },
      3: { // March
      ...
      9: { // September
        seasonal: [
          ...
          { title: 'Test smoke/CO detectors again (quarterly)', description: 'Press the test button on all smoke and carbon monoxide detectors to verify they work. Replace batteries (or do it on Daylight Saving Time change). Clean dust from sensors with a vacuum. Replace any detectors older than 10 years (smoke) or 7 years (CO).' },
        ...
        weatherSpecific: [
          ...
          { title: 'Begin winterizing outdoor equipment', description: 'Drain and store garden hoses indoors. Shut off and drain outdoor faucets (or install freeze-proof faucet covers). Remove window AC units or cover permanently installed units. Drain and winterize sprinkler systems. Store or cover outdoor furniture. Bring in sensitive plants.' },
      ...
      10: { // October
        seasonal: [
          { title: 'Complete fall cleanup and preparation', description: 'Rake leaves and remove from gutters. Trim dead branches. Aerate and overseed lawn. Mulch garden beds. Store or cover outdoor furniture. Drain and store hoses. Check all exterior maintenance before winter locks you out of outdoor work.' },
          ...
          { title: 'Winterize outdoor water systems', description: 'Drain sprinkler system (or blow out with compressed air). Remove, drain, and store garden hoses indoors. Shut off interior valves to outdoor faucets, open outdoor faucets, and drain pipes. Install faucet covers. Prevents frozen, burst pipes.' },
          { title: 'Turn off outside water sources', description: 'Locate shut-off valves inside your home for outdoor faucets (usually in basement or crawl space). Close these valves completely. Open outdoor faucets to drain remaining water. Leave them open all winter to prevent pressure buildup if any water remains.' },
          { title: 'Shut off outside house spigots', description: 'Close indoor shut-off valves for exterior faucets. Open outdoor faucets to drain trapped water. Detach and drain all hoses. Install insulated faucet covers for added protection. This critical step prevents burst pipes that cause thousands in water damage.' },
          ...
          { title: 'Test carbon monoxide detectors before heating season', description: 'Press test button on all CO detectors to ensure they work. Replace batteries or any detectors older than 7 years. Install detectors on every level, near bedrooms, and near fuel-burning appliances. CO poisoning is deadly and odorless.' },
    ...
    monthlyTasks: {
      ...
      11: { // November
        seasonal: [
          ...
          { title: 'Test heating system thoroughly', description: 'Run heating system regularly as temperatures drop. Listen for unusual noises. Verify even heating throughout home. Replace filters monthly during heating season. Monitor energy bills for unusual increases. Call technician immediately if any problems - Midwest winter demands reliable heat.' },
        ...
        weatherSpecific: [
          ...
          { title: 'Check heating system efficiency', description: 'Monitor that heating system maintains comfortable temperature without excessive runtime. Replace filters monthly. Listen for unusual sounds. Check vents are open and unblocked. If energy bills seem high or house doesn\'t heat well, call HVAC technician - winter is too long for inefficient system.' },
